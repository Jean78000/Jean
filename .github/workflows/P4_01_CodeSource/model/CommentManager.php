...
class CommentManager extends Manager {
    ...
    public function getComments($postId) {
        ...
        FROM blog_comments WHERE post_id = ? ORDER BY comment_date DESC');
    ...
    public function getComment($postId, $idComment) {
        ...
        $db = $this->dbConnect();
        $req = $db->prepare('SELECT id, post_id, author, comment FROM blog_comments WHERE post_id = ? AND id = ?');
    ...
    public function getModifyComment($author, $comment, $comment_date, $idComment) {
        ...
        $db = $this->dbConnect();
        $req = $db->prepare('UPDATE blog_comments SET author = ?, comment = ?, comment_date = ? WHERE id = ?');

...
var imageSelect = document.querySelectorAll("img");
console.log(imageSelect);
var tableauImage = Array.prototype.slice.call(imageSelect);
console.log(tableauImage);

function changeImg() {              
    document.slide.src = tableauImage[i];  /*la source est l'indice 0 : 1ére image*/
